...
class Ui_Lobby(object):
    def setupUi(self, Lobby):
        ...
        self.recentlyOpenedTable.setHorizontalHeaderItem(0, item)
        item = QtWidgets.QTableWidgetItem()
        self.recentlyOpenedTable.setHorizontalHeaderItem(1, item)
        self.recentlyOpenedTable.horizontalHeader().setStretchLastSection(True)
        self.recentlyOpenedTable.verticalHeader().setVisible(False)
        self.verticalLayout_2.addWidget(self.recentlyOpenedTable)
    ...
    def retranslateUi(self, Lobby):
        ...
        item = self.recentlyOpenedTable.horizontalHeaderItem(0)
        item.setText(_translate("Lobby", "Project"))
        item = self.recentlyOpenedTable.horizontalHeaderItem(1)
        item.setText(_translate("Lobby", "Last Modified"))
