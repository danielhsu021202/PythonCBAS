...
class Ui_PipelineDialog(object):
    def setupUi(self, PipelineDialog):
        ...
        self.applyNowButton = QtWidgets.QPushButton(parent=PipelineDialog)
        self.applyNowButton.setObjectName("applyNowButton")
        self.horizontalLayout_2.addWidget(self.applyNowButton)
    ...
    def retranslateUi(self, PipelineDialog):
        ...
        self.axisCombo.setItemText(0, _translate("PipelineDialog", "columns"))
        self.axisCombo.setItemText(1, _translate("PipelineDialog", "all cells"))
        self.indexEdit.setPlaceholderText(_translate("PipelineDialog", "column index/indices or name(s)"))
        ...
        self.operationCombo.setItemText(1, _translate("PipelineDialog", "not equal to"))
        self.operationCombo.setItemText(2, _translate("PipelineDialog", "less than"))
        self.operationCombo.setItemText(3, _translate("PipelineDialog", "less than or equal to"))
        self.operationCombo.setItemText(4, _translate("PipelineDialog", "greater than"))
        self.operationCombo.setItemText(5, _translate("PipelineDialog", "greater than or equal to"))
        self.operationCombo.setItemText(6, _translate("PipelineDialog", "in"))
        self.operationCombo.setItemText(7, _translate("PipelineDialog", "between"))
        ...
        self.applyNowButton.setText(_translate("PipelineDialog", "Apply Now"))
