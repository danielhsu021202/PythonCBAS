...
class CheckSequenceFilesDeep(unittest.TestCase):
        ...
        def translateExpectedToOutput(self, cont, length, expected_seq_num):
            """
        ...
        def test_translate(self):
            print(self.translateExpectedToOutput(0, 1, 0))
        ...
        def test_seqCnts_deep(self, percent=0.3):
            ...
            for f in expected_files:
                ...
                for _ in range(int(percent * expected.shape[1])):
                    ...
                    col_output = self.translateExpectedToOutput(cont, length, col_expected)
